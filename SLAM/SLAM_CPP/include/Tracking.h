...
public:
    ...
    cv::Mat GrabImageMonocular(const cv::Mat &im, const std::vector<BBX> ODbox, const double &timestamp);
...
protected:
    ...
    set<MapPoint *> mvpDirectMapPointsCache;
    int mnCacheHitTh = 150;
